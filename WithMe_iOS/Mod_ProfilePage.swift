...
struct Mod_ProfilePage: View {
    @ObservedObject private var userViewModel = Mod_UserViewModel()
    @ObservedObject private var postViewModel = Mod_PostProfileViewModel()
            ...
            ScrollView(.vertical) {
                VStack {
                    ...
                    Button {
                        ...
                        NavigationLink(
                            destination: Mod_EditProfilePage(),
